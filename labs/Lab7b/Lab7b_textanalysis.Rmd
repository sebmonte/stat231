...
Solution: A few examples of words not in the NRC lexicon but in the poems are 'day', 'thee', and 'tis'. 78% of words in Dickinson's poems are not scored in the NRC lexicon.
...
Solution: Dickinson's poems are positive overall as the total score of 1111 indicates more positive than negative words.
