...
Solution: x and y are negatively correlated, increases in x are associated with decreases in y. However, the correlation is very weak and so there is not much of a relationship.
...
Unlike the strong correlation found in the dino dataset,  the star dataset
...
appropriate measure since there is no clear correlation between the data
and rather it is intentionally selected to draw a pattern.
...
or shapes. Since most of them do not have any clearly strong association
between the x and y coordinates, correlation is not appropriate. However, slant_down and slant_up do show a general negative and positive
association between the x and y variables respectively, and so a correlation coefficient could be an effective summary.
