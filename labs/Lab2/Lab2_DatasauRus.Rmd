...
Solution: x and y are negatively correlated, increases in y are associated with decreases in x.
...
Solution: The relationship between x and y appears to be in a unique pattern, a drawing of a dinosaur, and so correlation is not appropriate.
