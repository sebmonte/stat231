...
Solution: The density of this graph is .031, indicating that it is not very dense at all compared to the proportion of possible edges that there could be.

```{r}
igraph::edge_density(got_igraph)
```
