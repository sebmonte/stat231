...
```{sql connection=aircon}
dbGetQuery(aircon, "SELECT carrier, COUNT(*) as n, AVG(arr_delay) as avg_arr_delay FROM flights WHERE day = 14 AND year = 2010 AND month = 5 AND dest = 'DFW' GROUP BY carrier HAVING avg_arr_delay > 60")
```
