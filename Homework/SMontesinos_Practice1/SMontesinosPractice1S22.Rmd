...
g <- ggplot(data = mpg, mapping = aes(x = displ, y = hwy)) +
  ...
  ggtitle("Miles per gallon and engine displacement across three types of drive train")
...
z <- ggplot(data = MetabolicRate, mapping = aes(x = BodySize, y = Mrate)) +
  geom_point() +
  coord_trans(y = "log10") +
  facet_wrap(~Instar, nrow = 3) +
  ggtitle("Maduca Sexta Body Size and Metabolic Rate over life stages") +
  ylab("Metabolic Rate") +
