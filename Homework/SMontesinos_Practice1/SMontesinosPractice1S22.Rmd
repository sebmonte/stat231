...
p <- ggplot(data = MLB_teams, mapping = aes(x = WPct, y = payroll))+
  ...
  ggtitle("MLB teams' win percentage, payroll, 
          and attendance") +
  ylab("Total Team Payroll") +
  xlab("Winning Percentage") +
  labs(color = "Attendance")
p
```
