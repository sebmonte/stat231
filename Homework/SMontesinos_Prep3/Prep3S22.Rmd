...
Solution: An API is a protocol for interacting with a program, so this package would likely provide access to public API for the arXiv website and so allow us to use data from it.
