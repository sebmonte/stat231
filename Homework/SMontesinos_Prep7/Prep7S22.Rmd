...
Solution: The idea of coordinate reference systems (CRS) and how to pick/use one when creating a map in R.
...
Solution: The map generated is like the one displayed in 17.3
...
Solution: The coordinates in the ggspatial package and choleradeaths are not in the same units.
...
Solution: 'crs' stands for coordinate reference system, a method for keeping track of geographic locations that comes in multiple forms.
...
Solution: This plot shows nearly all the deaths concentrated near people at the broad street water pump, so I agree that this pump seems to have been the problem for the outbreak.
...
Solution: The main businesses on modern-day Kingsly street seem to be restaurants and department stores.
