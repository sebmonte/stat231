...
p <- ggplot(data = activities_average, aes(x=day_of_week, y = Duration, color = Activity, group = Activity)) +
  geom_line(size = 1.2, alpha = 1) + 
  labs(title = "Average Work Time Per Class Over a Week",
       x = "Day", y = "Average Work Time (hours)",
       color = "Class")
