...
Does it make sense to start on the analysis as I collect the data if I have to eventually add more data? In other words is it easy to add in more data or would I need to rewrite the analysis portions?
