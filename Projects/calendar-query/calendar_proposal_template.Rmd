...
How much time do I spend on work during the week vs. during the weekends?
...
To investigate how much time I spend on different courses, I could calculate the average time I spend per week on each course and then plot this using a bar chart, with my various courses on the x axis and the time spend per week on the y axis. The relative size of each bar would be the cue that would represent these differences.
